...
- **name** <i>(optional string)</i> <br/> Allows you to give a name to the user.
- **if** <i>(optional condition)</i> <br/> Allows you to conditionally include the block.
- **once** <i>(optional boolean)</i> <br/> If set to `true`, the block will only be included once, even if the condition is met multiple times.
- **transcript** <i>(optional boolean)</i> <br/> Allows you to optionally add the User block to the Transcript
...
- **name** <i>(optional string)</i> <br/> Allows you to give a name to the assistant.
- **if** <i>(optional condition)</i> <br/> Allows you to conditionally include the block.
- **model** <i>(optional enum)</i> <br/> Tracks which model generated the assistant text
- **once** <i>(optional boolean)</i> <br/> If set to `true`, the block will only be included once, even if the condition is met multiple times.
- **transcript** <i>(optional boolean)</i> <br/> Allows you to optionally add the User block to the Transcript
