...
Here is a [cookbook](https://www.quora.com/What-is-a-cookbook-in-programming-language) of examples to help you get started with Glass and show off some of its features.
...
```glass copy filename="chatWithUserProfile.glass"
