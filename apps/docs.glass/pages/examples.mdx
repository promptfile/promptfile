...
Here you can declare variables that you can interpolate into your prompt. You can declare variables in the `<Init>` block and then use them in your prompt with the `@{}` syntax.
