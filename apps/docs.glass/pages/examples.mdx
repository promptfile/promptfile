...
Here you can declare variables that you can interpolate into your prompt. You can declare variables in the `<Init>{:glass}` block and then use them in your prompt with the `@{variableNameHere}` syntax. All variables must be inside a block.
