...
Working with Glass is easiest in Visual Studio Code via the <a href="https://marketplace.visualstudio.com/items?itemName=foundation.vscode-glass" class="link">Glass extension</a>. This extension provides the following features:
