...
const variantStyles = {
  primary:
    'rounded-lg bg-zinc-900 py-1 px-3 text-white hover:bg-zinc-700 dark:bg-accent-400/10 dark:text-accent-400 dark:ring-1 dark:ring-inset dark:ring-accent-400/20 dark:hover:bg-accent-400/10 dark:hover:text-accent-300 dark:hover:ring-accent-300',
  secondary:
  ...
  filled:
    'rounded-lg bg-zinc-900 py-1 px-3 text-white hover:bg-zinc-700 dark:bg-accent-500 dark:text-white dark:hover:bg-accent-400',
  outline:
