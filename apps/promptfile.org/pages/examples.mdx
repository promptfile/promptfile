...
```prompt copy filename="haiku.glass"
<Code>
...
```prompt copy filename="executeCode.glass"
<Code>
const userProfile = {
  name: 'Jane Doe',
  age: 25,
...
```prompt copy filename="websiteChat.glass"
<Code>
...
```prompt copy filename="promptChaining.glass"
<Test>
...
```prompt copy filename="state.glass"
<Code>
...
```prompt copy filename="classify.glass"
<Code>
const examples = [
  {
...
```prompt copy filename="conditionalLogic.glass"
<Code>
const [numMessages, setNumMessages] = useState(0)
