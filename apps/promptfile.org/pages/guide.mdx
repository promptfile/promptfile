...
Install the Promptfile VS Code extension through the VSCode Marketplace [here](https://marketplace.visualstudio.com/items?itemName=foundation.vscode-prompt).
