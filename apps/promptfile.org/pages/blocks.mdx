...
```prompt copy filename="assistantBlock_example.glass"
<Assistant if={true}>
Hello human!
</Assistant>
```
...
```prompt copy filename="blocks_example.glass"
<Code>
const conversation = [
  {
...
```prompt copy filename="user_example.glass"
<User if={true}>
Hello AI!
</User>
...
```prompt copy filename="system_example.glass"
<System if={false}>
...
```prompt copy filename="forLoop_example.glass"
<Code>
const examples = [{
  request: "Happy",
  response: "Sad",
...
```prompt copy filename="test_example.glass"
<Test>
...
```prompt copy filename="text_example.glass"
<User>
<Text if={true}>
I love you!
</Text>
...
```prompt copy filename="init_example.glass"
<Code>
...
```prompt copy filename="request_example.glass"
...
```prompt copy filename="function.glass"
<Tool
  name="calculator"
...
```prompt copy filename="function_example.glass"
<Tool
  name="calculator"
  description="Calculates the result of a math expression"
